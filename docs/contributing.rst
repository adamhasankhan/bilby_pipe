...
Before making a release, the [changelog](https://git.ligo.org/lscsoft/bilby_pipe/-/blob/master/CHANGELOG.md?ref_type=heads)
...
pull request should be opened automatically on the [bilby_pipe feedstock](https://github.com/conda-forge/bilby_pipe-feedstock)
